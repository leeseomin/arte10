...
cd s24
parallel gmic {} -fx_euclidean2polar 50,50,1,1,1 -o ../s5/{} ::: *.*
cd .. 
cd s5
for i in *.*; do
   convert $i  -set filename:new ../s25/"%teu" "%[filename:new].png"
done
cd ..
cd s24
for i in *.* 
...
cp s24/*.*  s25
cd s6
parallel gmic {} -fx_euclidean2polar 50,50,1,1,1 -o ../s15/{} ::: *.*
cd .. 
cd s15
for i in *.*; do
   convert $i  -set filename:new ../s25/"%tcpu1eu" "%[filename:new].png"
done
